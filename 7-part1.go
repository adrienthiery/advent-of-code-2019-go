...
func executeStep(program *[]int, baseIndex int, input int, output *int, debug bool) int {
...
func executeProgram(program []int, input int, output *int, debug bool) []int {
	if debug {
		fmt.Println(program)
	}
	...
	for returnedIndex != -1 {
		returnedIndex = executeStep(&returnedProgram, returnedIndex, input, output, debug)
	}
...
func main() {
	...
	// "TESTS"
	fmt.Println("Test1:")
	result1 := executeProgram(test1, testInput, &testOutput, false)
	...
	inputZero := 0
	test2Output := 999999
	executeProgram(test2, inputZero, &test2Output, false)
	fmt.Println(" passing: ", reflect.DeepEqual(test2Output, 0))

	inputNonZero := 12
	test2Output2 := 999999
	executeProgram(test2, inputNonZero, &test2Output2, false)
	...
	fmt.Println("Test3:")
	test3Output := 999999
	executeProgram(test3, inputZero, &test3Output, false)
	fmt.Println(" passing: ", reflect.DeepEqual(test3Output, 0))

	test3Output2 := 999999
	executeProgram(test3, inputNonZero, &test3Output2, false)
	...
	input4One := 4
	test4Output := 999999
	executeProgram(test4, input4One, &test4Output, false)
	fmt.Println(" passing: ", reflect.DeepEqual(test4Output, 999))

	input4Two := 8
	test4Output2 := 999999
	executeProgram(test4, input4Two, &test4Output2, false)
	fmt.Println(" passing: ", reflect.DeepEqual(test4Output2, 1000))

	input4Three := 10
	test4Output3 := 999999
	executeProgram(test4, input4Three, &test4Output3, false)
	...
	executeProgram(program, testInputReal, &output, false)
